...
[JMP-draft]:{{ site.baseurl }}{% link assets/files/Liqiang_Liu_JMP.pdf %}
...
The alphabetical ordering of authors is a prevalent convention in economics publications. This paper investigates the impacts of surname initials on occupational and location choices and career mobility between publication-oriented and non-publication-oriented positions among economics Ph.D. candidates. Utilizing a novel dataset of Ph.D. candidates from the top 15 U.S. economics departments between 2007 and 2015, we find that those with surname initials closer to the end of the alphabet are more likely to choose non-publication-oriented jobs and relocate to Asia for their initial placement. Additionally, these candidates are more likely to transition from publication-oriented to non-publication-oriented jobs over the longer term.
</small><br><br/></div>
