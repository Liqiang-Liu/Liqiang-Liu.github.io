  ...
  <span style="font-size: 16px;">I love reading econometric methods books, papers, and tweets in empirical research</span>
    <ul class="custom-bullet">
      <li><span style="font-size: 15px; font-family: monospace;">My favorite books:</span><br>
        Mostly Harmless Econometrics: An Empiricist's Companion<br>
        Causal Inference for Statistics, Social, and Biomedical Sciences: An Introduction<br>
        Counterfactuals and Causal Inference: Methods and Principles for Social Research<br>
